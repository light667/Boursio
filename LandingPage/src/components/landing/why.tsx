      ...
      <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-muted-foreground mb-8 leading-relaxed">
            Chaque année, des milliers d&apos;étudiants brillants passent à côté de bourses
            faute d&apos;information ciblée ou d&apos;outils de candidature adaptés. Boursio change définitivement la donne.
          </p>
