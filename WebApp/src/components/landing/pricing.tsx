      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="mb-16 text-center max-w-3xl mx-auto">
          ...
          <p className="mt-4 text-muted-foreground text-base max-w-xl mx-auto">
            Commencez gratuitement avec l'accès aux recommandations et à l'analyse, puis passez au
            plan Pro ou Max selon vos besoins.
          </p>
        </div>
        ...
        <div className="mt-12 text-center text-xs text-muted-foreground">
          Paiements sécurisés par Mobile Money (Wave, Orange Money, MTN MoMo, Moov) et Carte
