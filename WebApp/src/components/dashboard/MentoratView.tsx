      ...
      <div className="flex flex-col items-center justify-center rounded-2xl border border-border bg-card p-12 text-center shadow-card space-y-4 max-w-2xl mx-auto my-8">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-muted-foreground leading-relaxed max-w-md mx-auto">
            Le programme de mentorat individuel est en cours d'activation. Les profils vérifiés
            d'anciens boursiers (Eiffel, Rhodes, Chevening, MEXT, Mastercard Foundation) seront
            bientôt disponibles pour des sessions d'accompagnement direct.
          </p>
        </div>
