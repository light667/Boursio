    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center py-20 lg:py-28">
        ...
        <p className="mx-auto max-w-2xl text-base sm:text-xl text-muted-foreground leading-relaxed mb-12">
          ...
          les bourses sur-mesure, rédigera et optimisera vos dossiers, et suivra vos candidatures jusqu'au succès.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 max-w-3xl mx-auto mb-12">
          ...
          >
            ...
            <span className="font-display font-bold text-sm text-foreground">Boursio sur Play Store</span>
          </a>
          ...
          >
            ...
            <span className="font-display font-bold text-sm text-foreground">Boursio sur App Store</span>
          </a>
        </div>
      </div>
